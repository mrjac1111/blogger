...
<!-- Mirrored from hencework.com/theme/kenny/404.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 17 Oct 2017 11:39:32 GMT -->
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
    <title>Blogger 404</title>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-xs-12 text-center">
                                            ...
                                            <p class="font-12 mt-15">2018 &copy; Blogger</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
