            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 col-xs-12 hidden-xs xs-no-padding-lr text-right">
                      <div class="icon-social-very-small xs-width-100 xs-text-center display-inline-block">
                           <a href="https://twitter.com/" title="Twitter" target="_blank" class="text-link-white"><i class="fab fa-facebook-f"></i></a>
        ...
        <div class="container nav-header-container">
            <div class="row">
                ...
                <div class="col-md-2 col-xs-5">
                    <a href="/" title="Pofo" class="logo"><img src="{{asset('logo.png')}}" data-rjs="images/logo@2x.png" class="logo-dark default" alt="Pofo"><img src="images/logo-white.png" data-rjs="images/logo-white@2x.png" alt="Pofo" class="logo-light"></a>
                </div>
                <!-- end logo -->
